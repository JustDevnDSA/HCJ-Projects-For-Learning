...
modalCloseBtns.forEach((modalCloseBtn) => {
  modalCloseBtn.addEventListener("click", () => {
    ...
    slideNav.classList.remove("hide");
...
swiperSlides.forEach((swiperSlide) => {
  ...
  readMoreBtn.addEventListener("click", () => {
    ...
    if (startingElement) {
      ...
      const staringIndex = elementArray.indexOf(startingElement);
      const elementToHide = elementArray.slice(staringIndex);
...
modalBoxes.forEach((modalBox) => {
  ...
  modalCloseBtn.addEventListener("click", () => {
    ...
    if (startingElement) {
      ...
      const elementArray = Array.from(elements);
      const staringIndex = elementArray.indexOf(startingElement);
      const elementToShow = elementArray.slice(staringIndex);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openModal(cardTitle) {
    ...
    if (modalToOpen) {
      ...
      // Hide slider cards with a delay on click search  results
  ...
  //   Hide search results if the search input valus is 0(empty)
  searchInput.addEventListener("input", () => {
  ...
  //   Hide serach results when clicking outside the searh container
